...
class Author implements UserInterface
{
     ...
     */
    public function eraseCredentials()  // permet de supprimer des infos ssensibles stockées dans l'objet (ex:mdp en clair),
                                        // appelé a chaque fois que l'objet est sérialisé
    {
